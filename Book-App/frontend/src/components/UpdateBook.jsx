...
const UpdateBook = () => {
  ...
  const fetchBooks = async () => {
    try {
      const res = await axios.get('https://book-app-backend-bynh.onrender.com/books');
      setBooks(res.data);
    } catch (error) {
      console.error(error);
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://book-app-backend-bynh.onrender.com/books/${selectedBookId}`, formData);
